...
`,Zl=p.svg`
	...
	fill: transparent;
	stroke: #101828;
`,P="/assets/sprite-yC_Scu6s.svg",Sf=()=>{const[e,t]=pn(),r=hn(),n=e.get("page")||1;let a=parseInt(e.get("limit"))||4;const i=Object.fromEntries(e),u=(f,_)=>{const{type:g,checked:d,value:b}=_.target;g==="checkbox"&&d||g==="radio"&&d?e.set(f,b):e.delete(f),t(e)},l=f=>{f.target.value!==""?e.set("location",f.target.value):e.delete("location"),t(e)},m=f=>{f.preventDefault(),r(yo({page:n,limit:a,...i}))};return o.jsxs("form",{onSubmit:m,children:[o.jsxs(Xl,{children:[o.jsx("label",{children:"Location"}),o.jsxs(Yl,{children:[o.jsx(Zl,{children:o.jsx("use",{href:P+"#icon-location"})}),o.jsx(Jl,{type:"text",placeholder:"City",name:"location",onChange:l})]})]}),o.jsx(Gl,{children:"Filters"}),o.jsx(Jr,{children:"Vehicle equipment"}),o.jsxs(Zr,{children:[o.jsx(he,{type:"checkbox",name:"AC",value:1,onChange:f=>u("airConditioner",f),id:"AC"}),o.jsxs(ce,{htmlFor:"AC",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-ac"})}),o.jsx("span",{children:"AC"})]}),o.jsx(he,{type:"checkbox",name:"transmission",value:"automatic",onChange:f=>u("transmission",f),id:"transmission"}),o.jsxs(ce,{htmlFor:"transmission",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-automatic"})}),o.jsx("span",{children:"Automatic"})]}),o.jsx(he,{type:"checkbox",name:"kitchen",value:1,onChange:f=>u("kitchen",f),id:"kitchen"}),o.jsxs(ce,{htmlFor:"kitchen",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-kitchen"})}),o.jsx("span",{children:"Kitchen"})]}),o.jsx(he,{type:"checkbox",name:"TV",value:1,onChange:f=>u("TV",f),id:"TV"}),o.jsxs(ce,{htmlFor:"TV",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-tv"})}),o.jsx("span",{children:"TV"})]}),o.jsx(he,{type:"checkbox",name:"shower",value:1,onChange:f=>u("shower",f),id:"shower"}),o.jsxs(ce,{htmlFor:"shower",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-shower"})}),o.jsx("span",{children:"Showers/WC"})]})]}),o.jsx(Jr,{children:"Vehicle type"}),o.jsxs(Zr,{children:[o.jsx(he,{type:"radio",name:"form",value:"panelTruck",onChange:f=>u("form",f),id:"van"}),o.jsxs(ce,{htmlFor:"van",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-van"})}),o.jsx("span",{children:"Van"})]}),o.jsx(he,{type:"radio",name:"form",value:"fullyIntegrated",onChange:f=>u("form",f),id:"fullyIntegrated"}),o.jsxs(ce,{htmlFor:"fullyIntegrated",style:{position:"relative",justifyContent:"flex-end",padding:"9px"},children:[o.jsx(pe,{style:{position:"absolute",top:"9px"},children:o.jsx("use",{href:P+"#icon-alcove"})}),o.jsx("span",{children:"Fully Integrated"})]}),o.jsx(he,{type:"radio",name:"form",value:"alcove",onChange:f=>u("form",f),id:"alcove"}),o.jsxs(ce,{htmlFor:"alcove",children:[o.jsx(pe,{children:o.jsx("use",{href:P+"#icon-fully-integrated"})}),o.jsx("span",{children:"Alcove"})]})]}),o.jsx(Kl,{children:"Search"})]})},Ql=p.button`
	border-radius: 200px;
	border: none;
	padding: 16px 40px;
